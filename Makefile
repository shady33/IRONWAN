...
OBJS = \
    ...
    $O/src/LoRa/LoRaAeseMac.o \
    $O/src/LoRa/LoRaRadio.o \
    $O/src/LoRa/NetworkServerApp.o \
    $O/src/LoRa/PacketForwarder.o \
    $O/src/LoRaApp/AeseLoRaApp.o \
    $O/src/LoRaApp/AeseLoRaActuatorApp.o \
    ...
    $O/src/LoRaPhy/LoRaMediumCache.o \
    $O/src/LoRaPhy/LoRaNeighborCache.o \
