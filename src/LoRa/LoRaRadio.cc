...
void LoRaRadio::startTransmission(cPacket *macFrame, IRadioSignal::SignalPart part)
{
    ...
    currentFrequency = loRaTransmission->getLoRaCF();
...
Hz LoRaRadio::getCarrierFrequency()
{
    return currentFrequency;
}

void LoRaRadio::setCarrierFrequency(Hz carrierFrequency)
{
    currentFrequency = carrierFrequency;
}
