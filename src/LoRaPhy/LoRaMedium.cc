...
std::ostream& LoRaMedium::printToStream(std::ostream &stream, int level) const
{
...
void LoRaMedium::handleMessage(cMessage *message)
{
...
bool LoRaMedium::isRadioMacAddress(const IRadio *radio, const MACAddress address) const
{
...
bool LoRaMedium::isInInterferenceRange(const ITransmission *transmission, const Coord startPosition, const Coord endPosition) const
{
...
bool LoRaMedium::isInterferingTransmission(const ITransmission *transmission, const IListening *listening) const
{
...
bool LoRaMedium::isInterferingTransmission(const ITransmission *transmission, const IReception *reception) const
{
    const IRadio *transmitter = transmission->getTransmitter();
...
void LoRaMedium::removeNonInterferingTransmissions()
{
...
const std::vector<const IReception *> *LoRaMedium::computeInterferingReceptions(const IListening *listening, const std::vector<const ITransmission *> *transmissions) const
{
...
const std::vector<const IReception *> *LoRaMedium::computeInterferingReceptions(const IReception *reception, const std::vector<const ITransmission *> *transmissions) const
{
...
const IReception *LoRaMedium::computeReception(const IRadio *radio, const ITransmission *transmission) const
{
    receptionComputationCount++;
    return analogModel->computeReception(radio, transmission, getArrival(radio, transmission));
}
const IInterference *LoRaMedium::computeInterference(const IRadio *receiver, const IListening *listening, const std::vector<const ITransmission *> *transmissions) const
{
...
const IInterference *LoRaMedium::computeInterference(const IRadio *receiver, const IListening *listening, const ITransmission *transmission, const std::vector<const ITransmission *> *transmissions) const
{
    interferenceComputationCount++;
...
const IReceptionDecision *LoRaMedium::computeReceptionDecision(const IRadio *radio, const IListening *listening, const ITransmission *transmission, IRadioSignal::SignalPart part, const std::vector<const ITransmission *> *transmissions) const
{
...
const IReceptionResult *LoRaMedium::computeReceptionResult(const IRadio *radio, const IListening *listening, const ITransmission *transmission, const std::vector<const ITransmission *> *transmissions) const
{
...
const IListeningDecision *LoRaMedium::computeListeningDecision(const IRadio *radio, const IListening *listening, const std::vector<const ITransmission *> *transmissions) const
{
...
const IArrival *LoRaMedium::getArrival(const IRadio *receiver, const ITransmission *transmission) const
{
    return communicationCache->getCachedArrival(receiver, transmission);
}
const IListening *LoRaMedium::getListening(const IRadio *receiver, const ITransmission *transmission) const
{
    return communicationCache->getCachedListening(receiver, transmission);
}
const IReception *LoRaMedium::getReception(const IRadio *receiver, const ITransmission *transmission) const
{
...
const IInterference *LoRaMedium::getInterference(const IRadio *receiver, const ITransmission *transmission) const
{
    return getInterference(receiver, communicationCache->getCachedListening(receiver, transmission), transmission);
}
const IInterference *LoRaMedium::getInterference(const IRadio *receiver, const IListening *listening, const ITransmission *transmission) const
{
...
const INoise *LoRaMedium::getNoise(const IRadio *receiver, const ITransmission *transmission) const
{
    cacheNoiseGetCount++;
...
const ISNIR *LoRaMedium::getSNIR(const IRadio *receiver, const ITransmission *transmission) const
{
    cacheSNIRGetCount++;
...
const IReceptionDecision *LoRaMedium::getReceptionDecision(const IRadio *radio, const IListening *listening, const ITransmission *transmission, IRadioSignal::SignalPart part) const
{
...
void LoRaMedium::removeRadio(const IRadio *radio)
{
...
IRadioFrame *LoRaMedium::createTransmitterRadioFrame(const IRadio *radio, cPacket *macFrame)
{
    Enter_Method_Silent();
    take(macFrame);
...
IRadioFrame *LoRaMedium::createReceiverRadioFrame(const ITransmission *transmission)
{
    auto radioFrame = new RadioFrame(transmission);
    auto phyFrame = const_cast<cPacket *>(transmission->getPhyFrame());
...
void LoRaMedium::sendToAffectedRadios(IRadio *radio, const IRadioFrame *frame)
{
...
void LoRaMedium::sendToRadio(IRadio *transmitter, const IRadio *receiver, const IRadioFrame *frame)
{
...
IRadioFrame *LoRaMedium::transmitPacket(const IRadio *radio, cPacket *macFrame)
{
...
cPacket *LoRaMedium::receivePacket(const IRadio *radio, IRadioFrame *radioFrame)
{
...
const IListeningDecision *LoRaMedium::listenOnMedium(const IRadio *radio, const IListening *listening) const
{
...
bool LoRaMedium::isReceptionAttempted(const IRadio *receiver, const ITransmission *transmission, IRadioSignal::SignalPart part) const
{
    const IReception *reception = getReception(receiver, transmission);
    const IListening *listening = getListening(receiver, transmission);
    // TODO: why compute?
...
bool LoRaMedium::isReceptionSuccessful(const IRadio *receiver, const ITransmission *transmission, IRadioSignal::SignalPart part) const
{
    const IReception *reception = getReception(receiver, transmission);
    const IListening *listening = getListening(receiver, transmission);
    // TODO: why compute?
...
void LoRaMedium::sendToAllRadios(IRadio *transmitter, const IRadioFrame *frame)
{
    for (const auto radio : radios)
        if (radio != nullptr)
            sendToRadio(transmitter, radio, frame);
}
void LoRaMedium::receiveSignal(cComponent *source, simsignal_t signal, long value, cObject *details)
{
